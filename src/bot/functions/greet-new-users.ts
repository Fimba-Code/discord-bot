...
export const greetNewUsers = (member) => {
  ...
  if (!channel) return
  const moderadoresID = "<@&703604014704754708>"
  const [
    general,
    links,
    help,
  ...
  channel.send(`
    ...
    **Seja muito bem vinda(o) à nossa comunidade!** :rocket:
    ...
    > Nós desejamos que todos colaborem com a visão desta comunidade. Caso vejas que alguém esteja apresentando alguma conduta que não encoraja o crescimento da comunidade, por favor, use ${moderadoresID}  para que possamos ajudar.
